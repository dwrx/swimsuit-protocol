...
/// Default implementation of the NFT standard.
export const NFT_METADATA_SPEC = "swimsuit-1.0.0";
export const NFT_NAME = "Swimsuit Protocol";
export const NFT_SYMBOL = "SWIMSUIT";
